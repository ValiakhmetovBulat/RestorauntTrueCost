...
namespace RestorauntTrueCost.Server.Migrations
{
    ...
    [Migration("20230510085421_changed order period logic")]
    partial class changedorderperiodlogic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.OrdersToTables", b =>
                {
                    ...
                    b.HasOne("RestorauntTrueCost.Shared.Entities.TableOrder", "TableOrder")
                        .WithMany()
