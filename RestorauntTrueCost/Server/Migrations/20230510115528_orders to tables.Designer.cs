...
namespace RestorauntTrueCost.Server.Migrations
{
    ...
    [Migration("20230510115528_orders to tables")]
    partial class orderstotables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.OrdersToPositions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OrdersToPositions");
                });

            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.OrdersToTables", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.TableOrder", b =>
                {
                    ...
                    b.Property<int?>("OrdersToTablesId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.TableOrder", b =>
                {
                    ...
                    b.HasOne("RestorauntTrueCost.Shared.Entities.OrdersToTables", null)
                        .WithMany("TableOrder")
                        .HasForeignKey("OrdersToTablesId");
