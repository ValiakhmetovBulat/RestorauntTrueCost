...
namespace RestorauntTrueCost.Server.Migrations
{
    ...
    [Migration("20230517175724_added orders to positions table")]
    partial class addedorderstopositionstable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RestorauntTrueCost.Shared.Entities.OrderToPosition", b =>
                {
                    b.HasOne("RestorauntTrueCost.Shared.Entities.Cart", "Cart")
                        .WithMany()
